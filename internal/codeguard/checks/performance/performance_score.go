...
var performanceScoreWeights = map[string]int{
	...
	"performance.go.lock-held-across-blocking-call": 4,
	...
	"performance.go.nested-loop-scan":         2,
	"performance.go.slice-membership-in-loop": 2,
	"performance.cpp.range-for-copy":          2,
	"performance.cpp.flush-in-loop":           2,
