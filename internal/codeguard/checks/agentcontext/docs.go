...
// readmeDrift applies the same full extraction as agent docs to the root
// README: prose and inline-code references as well as fenced shell blocks.
// The README is the doc agents (and humans) read first, so it earns the same
// truthfulness bar.
