...
var miscCatalog = map[string]core.RuleMetadata{
	...
	"ci.missing-required-gate": {
		ID:               "ci.missing-required-gate",
		Section:          "CI/CD",
		DefaultLevel:     "fail",
		ExecutionModel:   core.RuleExecutionModelLanguageAgnostic,
		LanguageCoverage: core.RepositoryWideRuleLanguageCoverage(),
		Title:            "Missing required CI gate",
		Description:      "Fails when configured required gates such as test or security checks are absent from CI workflows.",
		HowToFix:         "Add the required workflow job or step, or update ci_rules.required_gates if the repository uses a different gate name.",
	},
	"ci.mutable-deployment-reference": {
		ID:               "ci.mutable-deployment-reference",
		Section:          "CI/CD",
		DefaultLevel:     "fail",
		ExecutionModel:   core.RuleExecutionModelLanguageAgnostic,
		LanguageCoverage: core.RepositoryWideRuleLanguageCoverage(),
